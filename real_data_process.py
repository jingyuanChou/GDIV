...
# Filter rows where the specific date falls between the Start Date and at least 14 days after the specific date in End Date
# Excluding 'mask mandate' policy
filtered_df = df[(df['Start Date'] <= specific_date) & (df['End Date'] >= date_plus_30) & (df['NPI measure'] != 'mask mandate')]
